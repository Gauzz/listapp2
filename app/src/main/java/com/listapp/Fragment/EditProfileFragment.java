...
//        stateName = "Madhya Pradesh";
    ...
    private void setPreviousData() {
        ...
        Call<Cities> citiesCall = apiInterface.getSupplierCity();
        citiesCall.enqueue(new Callback() {
            @Override
            public void onResponse(Call call, Response response) {
                ...
                Cities cities = (Cities) response.body();
                              cityList.addAll(cities.getmData());
                ArrayAdapter stateAdapter = new ArrayAdapter(getContext(), android.R.layout.simple_spinner_item, cityList);
                stateAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                retailerCity.setAdapter(stateAdapter);
