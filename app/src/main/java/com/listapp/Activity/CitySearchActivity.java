...
import com.listapp.Fragment.CityHomeFragment;
...
public class CitySearchActivity extends AppCompatActivity implements ExpandableListView.OnGroupClickListener, ExpandableListView.OnChildClickListener, OnClickListener {
...
//    private MarshMallowPermission marshMallowPermission;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setUpView();
        whichScreen = 1;
        getSupportFragmentManager().beginTransaction().replace(R.id.homeActivityFragment, new CityHomeFragment(), "").addToBackStack("").commit();
    ...
    protected void onResume() {
        ...
        if (!PreferenceConnector.readString(CitySearchActivity.this, "gotoNotification", "").equals("")) {
    ...
    private void setUpView() {
        ...
        search.setHint("Select City");
        search.setHintTextColor(ContextCompat.getColor(CitySearchActivity.this, R.color.dummyTextLightBlack));
        ...
        drawerIcon.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                AppUtil.hideKeyBoard(CitySearchActivity.this);
        ...
        navigationListAdapter = new NavigationListAdapter(CitySearchActivity.this, listDataHeader, listDataChild);
    ...
    private void getProfileDetail() {
        ...
        final ProgressDialog progressDialog = AppUtil.createProgressDialog(CitySearchActivity.this);
            ...
            public void onResponse(Call call, Response response) {
                ...
                if (getProfileResponse != null) {
                    ...
                    if (getProfileResponse.getError().equals("0")) {
                        PreferenceConnector.writeBoolean(CitySearchActivity.this, "firstTimeGetProfile", true);
                        PreferenceConnector.writeString(CitySearchActivity.this, PreferenceConnector.FULL_NAME, getProfileResponse.getData().getRetailerName());
                        PreferenceConnector.writeString(CitySearchActivity.this, PreferenceConnector.USER_ID, getProfileResponse.getData().getUserId());
                        PreferenceConnector.writeString(CitySearchActivity.this, PreferenceConnector.EMAIl, getProfileResponse.getData().getEmail());
                        PreferenceConnector.writeString(CitySearchActivity.this, PreferenceConnector.AREA, getProfileResponse.getData().getArea());
                        PreferenceConnector.writeString(CitySearchActivity.this, PreferenceConnector.ADDRESS, getProfileResponse.getData().getAddress());
                        PreferenceConnector.writeString(CitySearchActivity.this, PreferenceConnector.CITY, getProfileResponse.getData().getCity());
                        PreferenceConnector.writeString(CitySearchActivity.this, PreferenceConnector.STATE, getProfileResponse.getData().getState());
                        PreferenceConnector.writeString(CitySearchActivity.this, PreferenceConnector.SHOP_NAME, getProfileResponse.getData().getShopName());
                        PreferenceConnector.writeString(CitySearchActivity.this, PreferenceConnector.CONTACT_NUMBER, getProfileResponse.getData().getContactNumber());
                        PreferenceConnector.writeString(CitySearchActivity.this, PreferenceConnector.TIN_NUMBER, getProfileResponse.getData().getTinNumber());
                        PreferenceConnector.writeString(CitySearchActivity.this, PreferenceConnector.ESTD_YEAR, getProfileResponse.getData().getEstdYear());
                        PreferenceConnector.writeString(CitySearchActivity.this, PreferenceConnector.DL_NUMBER, getProfileResponse.getData().getDrugLicNo());
                        PreferenceConnector.writeString(CitySearchActivity.this, PreferenceConnector.CITY_ID, getProfileResponse.getData().getCityId());
                        PreferenceConnector.writeString(CitySearchActivity.this, PreferenceConnector.STATE_ID, getProfileResponse.getData().getStateId());
                        userName.setText(PreferenceConnector.readString(CitySearchActivity.this, PreferenceConnector.SHOP_NAME, ""));
                        String add = PreferenceConnector.readString(CitySearchActivity.this, PreferenceConnector.ADDRESS, "");
                        address.setText(add);
                        CitySearchActivity.this.mobileNumber.setText(PreferenceConnector.readString(CitySearchActivity.this, PreferenceConnector.MOBILE_NUMBER, ""));
                        ...
                        if (list != null) {
                            ...
                            PreferenceConnector.writeString(CitySearchActivity.this, PreferenceConnector.CONTACT_PERSON, strContactPerson.toString());
                        }
                        setData();
                    } else {
                        if (getProfileResponse.getMessage().equalsIgnoreCase("Your session has been expired")) {
                            AppUtil.sessionLogout(getProfileResponse.getMessage(), CitySearchActivity.this);
                        } else if (getProfileResponse.getMessage().equalsIgnoreCase("Your account has been deactivated by administrator"))
                            AppUtil.sessionLogout(getProfileResponse.getMessage(), CitySearchActivity.this);
                        else
                            AppUtil.showAlert(getProfileResponse.getMessage(), CitySearchActivity.this);
                    }
                } else
                    AppUtil.showAlert(getString(R.string.serverError), CitySearchActivity.this);
            }
    ...
    public boolean onGroupClick(ExpandableListView parent, View v, int groupPosition, long id) {
        ...
        switch (groupPosition) {
            ...
            case 9:
                ...
                AppUtil.hideKeyBoard(this);
                clearFragmentStack();
                AppUtil.userLogout(CitySearchActivity.this);
                break;
        }
        return false;
    }
