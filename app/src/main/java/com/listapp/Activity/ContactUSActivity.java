...
import com.listapp.Fragment.ContactUsFragment;
...
public class ContactUSActivity extends AppCompatActivity implements ExpandableListView.OnGroupClickListener, ExpandableListView.OnChildClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setUpView();
        whichScreen = 1;
        getSupportFragmentManager().beginTransaction().replace(R.id.homeActivityFragment, new ContactUsFragment(), "").addToBackStack("").commit();
    }
    ...
    private void setUpView() {
        ...
        navigationListAdapter = new NavigationListAdapter(ContactUSActivity.this, listDataHeader, listDataChild);
    ...
    public boolean onGroupClick(ExpandableListView parent, View v, int groupPosition, long id) {
        ...
        switch (groupPosition) {
            ...
            case 9:
                ...
                AppUtil.hideKeyBoard(this);
                clearFragmentStack();
                AppUtil.userLogout(ContactUSActivity.this);
                break;
        }
        return false;
    }
