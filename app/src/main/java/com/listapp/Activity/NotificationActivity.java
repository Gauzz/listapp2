...
import com.listapp.Fragment.NotificationListFragment;
...
public class NotificationActivity extends AppCompatActivity implements ExpandableListView.OnGroupClickListener, ExpandableListView.OnChildClickListener {
    ...
    public static String id, title, msg, time, date, type;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            id = getIntent().getStringExtra("notification_id");
            title = getIntent().getStringExtra("title");
            msg = getIntent().getStringExtra("msg");
            time = getIntent().getStringExtra("time");
            date = getIntent().getStringExtra("date");
            type = getIntent().getStringExtra("type");
            //  PreferenceConnector.writeString(NotificationActivity.this, id, id);
        } catch (Exception e) {
        }
        getSupportFragmentManager().beginTransaction().replace(R.id.homeActivityFragment, new NotificationListFragment(), "").addToBackStack("").commit();
    }
    ...
    private void setUpView() {
        ...
        navigationListAdapter = new NavigationListAdapter(NotificationActivity.this, listDataHeader, listDataChild);
    ...
    public boolean onGroupClick(ExpandableListView parent, View v, int groupPosition, long id) {
        ...
        switch (groupPosition) {
            ...
            case 9:
                ...
                AppUtil.hideKeyBoard(this);
                clearFragmentStack();
                AppUtil.userLogout(NotificationActivity.this);
                break;
        }
        return false;
    }
