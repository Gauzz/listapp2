...
public class OTPVerifyActivity extends AppCompatActivity implements View.OnClickListener , GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, MySMSBroadcastReceiver.OTPReceiveListener {
...
// can be made blocking using Tasks.await(task, [timeout]);
    ...
    public void onOTPReceived(String otp) {
        ...
        getAuthenticateOTP().setText(otp);
       this. otp = otp;
        if (CheckNetwork.isNetwordAvailable(OTPVerifyActivity.this))
            verifyOTp();
    }
